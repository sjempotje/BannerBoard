...
public class BannerBoardPlugin extends JavaPlugin {

    public static volatile BannerBoardPlugin instance;
    ...
    public void enable() throws IOException {
        ...
        this.saveResource("colors/color_palette_v1_16_R1.bc", false);
    ...
    public boolean onCommand(final CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 1 && args[0].equalsIgnoreCase("fontlist")) {
            ...
            if (!(sender instanceof Player)) {
                BannerBoardPlugin.msg(sender, "&DThis command can only be executed as a player.");
                return false;
            }
